"""
Django settings for gestion_etudiants project.
"""
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Supprimez cette ligne si le dossier static n'existe pas
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = ''  # Mettez votre email ici
EMAIL_HOST_PASSWORD = ''  # Mettez votre mot de passe d'application ici
